...
;
const metadata = {
    title: "AI Project Planner - Smart Microsoft Project Alternative",
    description: "AI-powered project planning tool that generates WBS, schedules, resource allocation, and exports to Microsoft Project format",
    generator: "v0.app",
    keywords: "project management, microsoft project, gantt chart, WBS, AI planning, project scheduling",
    icons: {
        icon: [
            {
