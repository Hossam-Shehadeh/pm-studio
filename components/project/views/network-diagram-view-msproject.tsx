        ...
        <CardContent>
          {!networkResult.isValid && (
            <div className="mb-4 p-4 bg-destructive/10 border border-destructive rounded-lg">
              <p className="text-destructive font-semibold">Network Diagram Errors:</p>
                    ...
                    {showDates && schedule && (
                      <>
                        <text
                          ...
                          style={{ fontSize: "9px" }}
                        >
                          ES: {schedule.earlyStart}d ({formatDate(schedule.earlyStart)})
                        </text>
                        <text
                          x={node.x + 5}
                          y={node.y + 75}
                          ...
                          style={{ fontSize: "9px" }}
                        >
                          EF: {schedule.earlyFinish}d ({formatDate(schedule.earlyFinish)})
                        </text>
                      </>
                    )}
                    ...
                    {showDates && schedule && (
                      <>
                        ...
                        <text
                          ...
                          style={{ fontSize: "9px" }}
                        >
                          LF: {schedule.lateFinish}d
                        </text>
                      </>
                    )}

                    {/* Float */}
                    {showFloat && schedule && schedule.totalFloat > 0 && (
                      <text
                        x={node.x + node.width / 2}
                        y={node.y + 90}
                        textAnchor="middle"
